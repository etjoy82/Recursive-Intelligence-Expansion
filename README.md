<span id="document-top">↪️ For returning users: <span style="white-space: nowrap; display: inline-block;">[📚 Quick Reference](#acronyms)</span> • <span style="white-space: nowrap; display: inline-block;">[🧭 Self-Select](#self-select)</span> • <span style="white-space: nowrap; display: inline-block;">[🚀 Start Here](#start-here)</span> • <span style="white-space: nowrap; display: inline-block;">[🗂️ Table of Contents](#toc)</span> • <span style="display: inline-block; white-space: nowrap; width: auto;">[🐦‍🔥&nbsp;Wiki](https://github.com/etjoy82/Recursive-Intelligence-Expansion/wiki)</span>
